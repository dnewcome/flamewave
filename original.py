...
bpy.ops.mesh.primitive_uv_sphere_add(
    ...
    location=(0, 0, attach_h)
)
trigger_zone = bpy.context.object
trigger_zone.name = "Trigger_Zone_Indicator"
trigger_m = mat("Trigger_Zone", (1.0, 0.4, 0.0), metallic=0.0, roughness=0.8)
trigger_zone.data.materials.append(trigger_m)
trigger_zone.display_type = 'WIRE'
